      ...
      <Router>
        ...
        <main className="main-content">
          <Routes>
            ...
            <Route exact path="/pedidos" element={<HistoricoPedidos clienteId={clienteId} />} />
            <Route exact path="/finalizar-pedido" element={<FinalizarPedido clienteId={clienteId} carrinhoId={carrinhoId} />} />
